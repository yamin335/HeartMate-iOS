//
//  WhatWorksInvitationDetailViewController.swift
//  iosbingo
//
...
class WhatWorksInvitationDetailViewController: UIViewController {
    ...
    func getWorksDetail(){
        ...
        let params = ["guide_id": 2] as [String:Any]
    ...
    func submitAnswer(vote:Int){
        AppLoader.shared.show(currentView: self.view)
        let params = ["guide_id": 2,"vote":vote] as [String:Any]
    ...
    func updateUI(){
        ...
        let nextBtnTitle = "Start a dating journey today"
