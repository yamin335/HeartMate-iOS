//
//  WhatWorkDetailViewController.swift
//  iosbingo
//
...
class WhatWorkDetailViewController: UIViewController{
    ...
    func getWorksDetail(){
        ...
        let params = ["guide_id": 1] as [String:Any]
    ...
    func submitAnswer(vote:Int){
        AppLoader.shared.show(currentView: self.view)
        let params = ["guide_id": 1,"vote":vote] as [String:Any]
    ...
    func updateUI(){
        ...
        let nextBtnTitle = "Update Inventory of My Life"
