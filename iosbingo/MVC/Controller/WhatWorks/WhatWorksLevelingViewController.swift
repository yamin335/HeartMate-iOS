//
//  WhatWorksLevelingViewController.swift
//  iosbingo
//
...
class WhatWorksLevelingViewController: UIViewController {
    ...
    func getWorksDetail(){
        ...
        let params = ["guide_id": 3] as [String:Any]
    ...
    func submitAnswer(vote:Int){
        AppLoader.shared.show(currentView: self.view)
        let params = ["guide_id": 3,"vote":vote] as [String:Any]
    ...
    func updateUI(){
        ...
        let nextBtnTitle = "Update Dating Journal"
